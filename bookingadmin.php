...
<body>
    ...
    <div class="container mt-4">
        <h1 class="navbar-brand text-success logo h1 align-self-center">Semua Jadwal</h1>
        ...
        <table class="table table-borderless table-responsive card-1 p-4">
            ...
            $result = mysqli_query($con, "SELECT * FROM booking  ORDER BY TIME(jam_selesai), jam_selesai");
            ...
            ?>
                ...
                <tbody>
                    <tr class="border-bottom">
                        ...
                        <?php echo "<td><a href='cetakjadwal.php?id=$r[id]'> Cetak</a> | <a href='editbookingadmin.php?id=$r[id]'>Edit</a> | <a href='authdeleteadmin.php?id=$r[id]'>Delete</a></td>" ?>
                    </tr>

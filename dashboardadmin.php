...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="dashboardadmin.php">
                Futsalan
            </a>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="bookingadmin.php">Booking</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="aboutadmin.php">About</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./assets/img/index1.png" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Futsalan</b></h1>
                                <h3 class="h2">Penyedia Lapangan Futsal</h3>
                                <p>
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                <h1 class="h1">Tetap Sehat</h1>
                                <h3 class="h2">Jangan lupa olahraga</h3>
                                <p>
                                    dengan futsal dapat membuat hidup anda menjadi lebih sehat, berenerjik dan kuat menjalani masalah masalah kehidupan.
                                    tidak lupa dengan bermain futsal disini dapat mengurangu masalah keuangan karena harga bersahabat.
                                </p>
                            </div>
                        </div>
                    </div>

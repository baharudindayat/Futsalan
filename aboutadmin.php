...
TemplateMo 559 Tumbas Shop

https://templatemo.com/tm-559-Tumbas-shop
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>About Us</h1>
                    <p>
                        Penyedia lapangan futsal merupakan salah satu usaha jasa yang mulai bermunculan karena antusiasme masyarakat dalam berolahraga, khususnya olahraga futsal. Keputusan konsumen untuk membeli jasa penyedia lapangan futsal merupakan hal yang penting bagi keberlanjutan usaha.
                    </p>
                </div>
                <div class="col-md-4">
                    <img src="assets/img/index2.png" alt="About Hero">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Online Services</h2>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Profit</h2>
                </div>
            </div>

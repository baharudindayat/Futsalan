...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO admin (nama,username, password ) VALUES ('$name','$username','$pass')";
    $result   = mysqli_query($con, $query);
    if ($result) {
        $error =  'Registrari Berhasil !!';
    } else {
        echo "<div class='form'>
                  <h3>Required fields are missing.</h3><br/>
                  <p class='link'>Click here to <a href='signupadmin.php'>registration</a> again.</p>
                  </div>";
    }
}
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                    <div class="card shadow-lg">
                        <div class="card-body p-5">
                            <form class="form-container" action="signupadmin.php" method="POST">

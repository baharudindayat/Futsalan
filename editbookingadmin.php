...
<body>
    ...
    $id = $_GET['id'];
    $result = mysqli_query($con, "SELECT * FROM booking where id = '$id'");
    ...
    <div class="container mt-4">
        <h1 class="navbar-brand text-success logo h1 align-self-center">Form Edit</h1>
        <form action="editbookingadmin.php" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="time" class="form-control" step='3600' name="jammulai" id="jammulai" value=<?php echo $jammulai; ?>>
            </div>
            <div class="mb-3">
                <label for="jamselesai" class="form-label">Jam Selesai</label>
                <input type="time" class="form-control" step='3600' name="jamselesai" id="jamselesai" value=<?php echo $jamselesai; ?>>
            </div>
            <input type="hidden" name="id" value=<?php echo $id ?>></td>
            <button type="submit" name="update" class="btn btn btn-success btn-block">Submit</button>
        </form>
    </div>
